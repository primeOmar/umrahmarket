...
const HeroSection = () => {
  ...
  const filterGroups = [
    ...
    },
    {
      ...
      type: 'month',
      options: [
        { id: 'muharram', label: 'Muharram', icon: '🕋', description: '1st month - Sacred month' },
        { id: 'safar', label: 'Safar', icon: '🌙', description: '2nd month' },
        { id: 'rabi_al_awwal', label: 'Rabi al-Awwal', icon: '🌟', description: '3rd month - Birth of Prophet' },
        { id: 'rabi_al_thani', label: 'Rabi al-Thani', icon: '🌙', description: '4th month' },
        { id: 'jumada_al_awwal', label: 'Jumada al-Awwal', icon: '🌙', description: '5th month' },
        { id: 'jumada_al_thani', label: 'Jumada al-Thani', icon: '🌙', description: '6th month' },
        { id: 'rajab', label: 'Rajab', icon: '🕌', description: '7th month - Sacred month' },
        { id: 'shaban', label: 'Shaban', icon: '🌙', description: '8th month' },
        { id: 'ramadan', label: 'Ramadan', icon: '🌙', description: '9th month - Fasting month' },
        { id: 'shawwal', label: 'Shawwal', icon: '⭐', description: '10th month - Eid al-Fitr' },
        { id: 'dhul_qaada', label: 'Dhul-Qaada', icon: '🌙', description: '11th month - Sacred month' },
        { id: 'dhul_hijjah', label: 'Dhul-Hijjah', icon: '🕋', description: '12th month - Hajj & Eid al-Adha' },
        { id: 'all_months', label: 'Any Month', icon: '📆', description: 'Available all year', exclusive: true },
      ]
    }
  ];
